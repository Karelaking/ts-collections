...
export const scenarios = [
  // ── ArrayList ──────────────────────────────────────────────────
  {
    ...
    fn: (size) => () => {
      ...
      for (let i = 0; i < size; i++) list.add(i);
    },
  },
  {
    name: "ArrayList",
  ...
  // ── HashMap ────────────────────────────────────────────────────
  {
    ...
    fn: (size) => () => {
      ...
      for (let i = 0; i < size; i++) map.put(`k${i}`, i);
    },
  },
  {
    name: "HashMap",
  ...
  // ── LinkedQueue ────────────────────────────────────────────────
  {
    ...
    fn: (size) => () => {
      ...
      for (let i = 0; i < size; i++) queue.offer(i);
      for (let i = 0; i < size; i++) queue.poll();
    },
  },
  ...
  // ── LinkedStack ────────────────────────────────────────────────
  {
    ...
    fn: (size) => () => {
      ...
      for (let i = 0; i < size; i++) stack.pop();
    },
  },
];
